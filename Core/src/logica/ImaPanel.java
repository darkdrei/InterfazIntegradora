 ...
 *
 */
public class ImaPanel extends JLabel{
	...
	/**
	 * A listener to an {@link ImaPanel}, this listener opens a
	 * popup showing the full sized image of the enclosing <code>ImaPanel</code>.
	 * @author Benjamin Sigg
	 *
	 */
	private class Listener extends MouseAdapter{
		...
		public void mousePressed( MouseEvent e ){
			if( popup == null && image != null ){
				...
				SwingUtilities.convertPointToScreen(location, ImaPanel.this );
				
				popup = PopupFactory.getSharedInstance().getPopup(ImaPanel.this, label, location.x, location.y );
				popup.show();
			}
		}
